...
export default defineUnlistedScript(() => {
  ...
  const actionsRoot =
    document.getElementById(actionsId) ?? document.body ?? document.documentElement
  ...
  button.addEventListener("click", async () => {
    ...
    window.postMessage({ source: GUIDE_MESSAGE_SOURCE, type: GUIDE_MESSAGE_TYPE, markdown }, "*")
  })
